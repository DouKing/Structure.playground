...
solution.minDays([1,10,3,10,2], 3, 1)       // 3
solution.minDays([7,7,7,7,12,7,7], 2, 3)    // 12
solution.minDays([1,10,3,10,2], 3, 2)       // -1
solution.minDays([1000000000,1000000000], 1, 1) // 1000000000
